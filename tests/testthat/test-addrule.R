  ...
  tryCatch(
    {
      ...
      kw_baseline_builder <- elbird:::kiwi_builder_init_(
      ...
      kw_orig_ptr <- elbird:::kiwi_builder_build_(kw_baseline_builder, NULL, -1)
      ...
      kb_rule_builder_ptr <- elbird:::kiwi_builder_init_(
        elbird:::kiwi_model_path_full("base"),
        0,
        elbird:::kiwi_default_build_options(),
        Dialect$STANDARD
      ...
      kw_with_rule_ptr <- elbird:::kiwi_builder_build_(kb_rule_builder_ptr, NULL, -1)
